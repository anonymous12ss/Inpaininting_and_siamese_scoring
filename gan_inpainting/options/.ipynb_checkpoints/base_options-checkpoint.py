...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='5000_img_ffhq_8000_children', help='name of the experiment.')
        ...
        parser.add_argument('--img_file', type=str, default='/mnt/recsys/daniel/datasets/ffhq_8000_children/256/percent0_5000imgs/img', help='training and testing dataset')
